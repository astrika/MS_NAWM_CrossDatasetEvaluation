...
Control_GEmatrix <- GE.control.WM
Control_coexpression <- cor(t(Control_GEmatrix))

# consider top module of X module
XtopModule <- read.delim("C:/Users/amanuel1/Dev/ZhaoLab/MS/GeneExpressionProfiles/EW/RNAseq/EW_MS_NAWM_TopModule17.txt", as.is = T)
...
# where do you want images to save? Please update to your working director: 
setwd("C:/Users/amanuel1/Dev/ZhaoLab/MS/GeneExpressionProfiles/EW/RNAseq")
...
for(i in seq(1:nrow(XtopModule))){
  ...
  ggsave(filename = paste(case, "Edge", i, ".jpg"), plot=full, width= 2, height = 8, unit="in", dpi=150)
